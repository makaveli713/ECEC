...
namespace Art713.ECEC.Encrypt
{
    class Encrypt
    {
        ...
        public BigInteger RecieverSecretKey
        {
            //get { return 713; }
            get; set; }
        public Point RecieverPublicKey
        {
            //get { return EllipticCurve.PointMultiplication(EllipticCurve.Generator, RecieverSecretKey); }
            get; set; }

        public Encrypt(string textToEncrypt /*int text*/)
        {
            ...
            if (textToEncryptBigInteger < EllipticCurve.P)
            {
                ...
                //var encryptedText = Auxiliary.Math.Mod(text * P.Abscissa, EllipticCurve.P);
        ...
        public void Decrypt(Point Rpoint, BigInteger encryptedText)
        {
            ...
            byte[] myTemp = txt.ToByteArray();
            var encoding = new UTF8Encoding();
            var finalTemp = encoding.GetString(myTemp);
